...
const translations = {
    'zh-Hant': {
        ...
        'd1_t3_title': 'Keynote',
        'd1_t3_track': '會場1',
        'd1_t4_s1_title': '建構 AI Agent：結合 Google Gemini 與 ADK 工具來解放企業生產力',
        'd1_t4_s2_title': 'React Server Components 深度實戰',
        'd1_t5_s1_title': 'Kubernetes 在生產環境的最佳實踐',
        'd1_t5_s2_title': 'IoT 數據的即時分析與預測',
        'd1_t5a_title': '中午休息',
        ...
        'session_abstract_title': '議程簡介：',
        'speaker_bio_title': '講者簡介：',
        ...
        'staff_title': '志工介紹',
        'vlab_online_name': 'vLAB Online',
        'vlab_online_category': '技術交流社群',
        'vlab_online_desc': 'vLAB Online（ 台灣路由網路實驗中心 ）是一個由熱愛技術的工程師自發組成的技術社群，早期以 Cisco 與路由網路技術為核心，提供線上交流與實驗環境，協助成員學習與實作。隨著技術演進與社群需求轉變，vLAB 逐步擴大討論主題，涵蓋資安、雲端、開源工具、AI 與數位治理等多元領域，並轉型為以 Line 群為中心的即時交流平台。',
    ...
    'en': {
        ...
        'd1_t3_title': 'Keynote',
        'd1_t3_track': 'Track 1',
        'd1_t4_s1_title': 'Building AI Agents: Combining Google Gemini and ADK Tools to Unleash Enterprise Productivity',
        'd1_t4_s2_title': 'Deep Dive into React Server Components',
        'd1_t5_s1_title': 'Kubernetes Best Practices in Production',
        'd1_t5_s2_title': 'Real-time Analysis and Prediction of IoT Data',
        ...
        'staff_title': 'Staff',
        'vlab_online_name': 'vLAB Online',
        'vlab_online_category': 'Technical Community',
        'vlab_online_desc': 'vLAB Online (Taiwan Routing Network Lab Center) is a technical community spontaneously formed by engineers passionate about technology. Initially focused on Cisco and routing network technologies, it provided an online exchange and lab environment to help members learn and practice. As technology evolved and community needs changed, vLAB gradually expanded its discussion topics to cover diverse fields such as cybersecurity, cloud, open-source tools, AI, and digital governance, and transitioned into a real-time communication platform centered around a Line group.',
        ...
        'after_buffet_content': '議程結束，Buffet 開始！讓我們一起到「高雄商旅 Urban Café 都會美饌」享用美味的 After Buffet，邊吃邊聊邊交流。<br><br>地點：<a href="https://maps.app.goo.gl/y9jiDaV2RFedoLkk7" target="_blank" rel="noopener noreferrer">查看地圖</a>',
        'stw_section_title': '🧑‍🤝‍🧑 南臺灣技術社群大聚',
        'stw_section_content': '11/23（星期日） 11:00~17:00',
        'networking_title': '⭐ 眾多技術人的聊天交流或 Lightning Talk',
        'networking_content': '在這場活動旨在聚集眾多的技術社群組織者、技術工作者們參與 (包括但不限於： Mobile、前端、後端、AI、敏捷、系統、DevOps、設計、PM、Marketing Tech 等等)，在這個活動中可以有機會與不同領域的參與者們聊天交流、切磋技術、交流辦活動的想法，必定會有滿滿的收穫。<br><br>如果你有一個小議題或專案想要和所有人分享，這場活動中有一個時段與開放式舞台 (含投影設備) 提供登記閃電講，時間約在 3 - 5 分鐘，可以利用這個機會曝光你的議題或專案分享。',
        'tech_market_title': '⭐ 首次引入南臺灣的技術創作市集',
        'tech_market_content': '發想自日本的「技術書典」，這是一個專為技術社群打造的創作展示平台。透過實體攤位，創作者可以直接與會眾互動，展示並販售自己的技術創作作品，讓知識與創意在社群中流動。<br><br>報名擺攤：<a href="https://forms.gle/ZpXHk8VbA7q9bsWQ9" target="_blank" rel="noopener noreferrer">立即報名</a>',
        'meeting_room_title': '⭐ 主題討論會議室',
        'meeting_room_content': '提供了兩個會議室，讓參與者可以自行登記，呼朋引伴在會議室中聊天或分享較長的議題。在與他人進行眾多議題的交流中，很有可能會找到一個聚焦的議題和聽眾，此時非常推薦你立刻登記會議室坐下來和大家進行一個時段的議題深度交流。',
        'food_drinks_title': '⭐ 食物、點心、飲料',
        'food_drinks_content': '知識的交流可能會需要更多的美好零食來刺激，本次活動提供零食點心等下午茶供參與者自由取用。',
        ...
        'code_conduct_content': '所有參與者皆需遵守 GDG 活動行為準則，以確保所有人都能在一個安全友善的環境中學習與交流。<br><br>詳細內容請參閱：<a href="https://gdg.tw/code_of_conduct/" target="_blank" rel="noopener noreferrer">GDG 行為準則</a>',
        'privacy_title': '✔️ 袒集個人資料告知事項暨個人資料提供同意聲明',
        'privacy_content': '我們尊重並保護您的個人隱私<br><br>詳細內容請參閱：<a href="https://docs.google.com/document/d/1_rTlfAkLMl5ZfFwxZrNPhwzGQ5xU8g96bXyKZ3siW-4" target="_blank" rel="noopener noreferrer">隱私權政策</a>/edit?usp=sharing',
    },
    'ja': {
        'nav_home': 'ホーム',
        'nav_schedule': 'スケジュール',
        ...
        'staff_title': 'スタッフ',
        'vlab_online_name': 'vLAB Online',
        'vlab_online_category': '技術交流コミュニティ',
        'vlab_online_desc': 'vLAB Online（台湾ルーティングネットワーク実験センター） は、技術を愛するエンジニアが自発的に設立した技術コミュニティです。初期は Cisco とルーティングネットワーク技術を核として、メンバーの学習と実践を支援するためのオンライン交流および実験環境を提供していました。技術の進化とコミュニティのニーズの変化に伴い、vLAB は討議テーマを徐々に拡大し、サイバーセキュリティ、クラウド、オープンソースツール、AI、デジタルガバナンスなど多様な分野を網羅するようになり、現在は Line グループを中心としたリアルタイム交流プラットフォームへと変貌しました。',
        'about_title': '私たちについて',
